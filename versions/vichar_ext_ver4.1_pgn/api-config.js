...
// Update this to match your FastAPI server deployment
const API_CONFIG = {
  ...
  // Function specifically for the analysis endpoint
  async function analyzePosition(message, fen, pgn = null, chatHistory = []) {
